...
(function () {
    ...
    */
    ...
    /**
     * get list of user in the system
     */
    this.listUser = function (callback) {
        this.rocketChatClient.users.list(callback);
    };

    /**
     * update Status of User
     * @param userId id of user
     * @param updateData data, which will be updated
     * @param callback will invoke after updating data
     */
    this.updateStatus = function (userId, updateData ,callback) {
        this.rocketChatClient.users.update(userId, updateData, callback);
    }
     ...
     * 
     */
    this.chathistory = function (chatId, callback) {
        this.rocketChatClient.im.history(chatId, callback);
    }
    /**
     * 
     */
    this.listDirectChat = function(options, callback) {
        this.rocketChatClient.im.listEveryone(options ,callback);        
    }
     ...
     * @param callback invoke after sent msg successfully
     */
    this.sendMsgAvatar = function (roomId, message, callback) {
        this.rocketChatClient.chat.postMessage({ roomId : roomId, attachments :[{ image_url: message}] }, callback);
    };
